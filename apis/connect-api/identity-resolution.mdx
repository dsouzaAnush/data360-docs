...
```python trigger_job.py icon=python lines highlight={4-7,8-12,14-16}
import requests
...
```java GetJobStatus.java icon=java lines highlight={3-7}
...
- [Identity Resolution Best Practices](/developer-guide/identity-resolution-best-practices) - Strategies for trusted unified profiles
