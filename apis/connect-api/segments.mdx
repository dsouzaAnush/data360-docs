...
<RequestExample>
```json Request highlight={2-4,6-22}
{
...
```python get_segment_members.py icon=python lines highlight={4-6,8-9,11-13}
import requests
...
```java PublishSegment.java icon=java lines highlight={3-8}
