...
<RequestExample>
```json Request Body highlight={2-12}
{
  "data": [
    {
      "EventId__c": "evt_001",
...
<ResponseExample>
```json Success (200) highlight={2-3}
{
  "accepted": 2,
  "rejected": 0,
  "errors": []
...
```json Partial Success (200) highlight={2-3,5-9}
{
  "accepted": 1,
  "rejected": 1,
  "errors": [
...
<RequestExample>
```json Batch Request highlight={2-5}
{
  "data": [
...
<ResponseExample>
```json Batch Response highlight={2-3}
{
...
<RequestExample>
```json partial_update.json icon=database highlight={3-5}
{
  "data": [{
