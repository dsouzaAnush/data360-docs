...
```bash generate_keys.sh icon=terminal lines highlight={2,5,8,11}
...
```java JwtConnection.java icon=java lines highlight={6-8,11}
...
```java LoadKeyFromFile.java icon=java lines highlight={5,8-10}
...
```java UsernamePasswordAuth.java icon=java lines highlight={6-9,12}
import java.sql.Connection;
import java.sql.DriverManager;
import java.util.Properties;
...
```java SandboxConnection.java icon=java lines highlight={2,5}
...
```java ObtainRefreshToken.java icon=java lines highlight={2-6}
...
```java RefreshTokenAuth.java icon=java lines highlight={6-8}
import java.sql.Connection;
import java.sql.DriverManager;
import java.util.Properties;
...
```java DirectTokenAuth.java icon=java lines highlight={6-7}
import java.sql.Connection;
import java.sql.DriverManager;
import java.util.Properties;
...
```java EnvVarsAuth.java icon=java lines highlight={6-9,11-12}
import java.sql.Connection;
import java.sql.DriverManager;
import java.util.Properties;
...
```java ErrorHandling.java icon=java lines highlight={4-5,7-15}
import java.sql.*;
