...
```java BasicConfig.java icon=java lines highlight={2-5,7-10}
...
```java DataspaceConfig.java icon=java lines highlight={6}
Properties props = new Properties();
props.setProperty("user", "your.email@example.com");
props.setProperty("password", "YourPassword123!");
props.setProperty("clientId", "YOUR_CONSUMER_KEY");
...
```java PerformanceConfig.java icon=java lines highlight={9-12}
Properties props = new Properties();
// Authentication
props.setProperty("user", "your.email@example.com");
props.setProperty("password", "YourPassword123!");
...
```java SSLConfig.java icon=java lines highlight={9-10}
Properties props = new Properties();
// Authentication
props.setProperty("user", "your.email@example.com");
props.setProperty("password", "YourPassword123!");
...
```bash convert_keys.sh icon=terminal lines highlight={2-4,7}
...
```java LoadKeyFile.java icon=java lines highlight={4-6,9-11}
...
```java LoadKeyEnv.java icon=java lines highlight={1-2,5-7}
...
```java HikariConfig.java icon=java lines expandable highlight={6-8,11-13,16-20,22}
...
```java DBCP2Config.java icon=java lines expandable highlight={4-7,10-12,15-17}
...
```properties application.properties icon=code lines highlight={1-3,6-8,11-13}
...
```yaml application.yml icon=code lines highlight={3-5,7-13}
spring:
  datasource:
...
```java DebugConfig.java icon=java lines highlight={5}
