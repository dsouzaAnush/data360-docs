...
```python icon=python lines highlight={3-8}
...
```python client_credentials_example.py icon=python lines highlight={4-10,14-16}
from salesforce_cdp_connector import SalesforceCDPConnection
...
```python obtain_tokens.py icon=python lines highlight={7-13,16-24,27-28}
import requests
...
```python token_flow_example.py icon=python lines highlight={4-10,14-16}
from salesforce_cdp_connector import SalesforceCDPConnection
...
```python env_config.py icon=python lines highlight={4-9}
import os
from salesforce_cdp_connector import SalesforceCDPConnection
...
```python context_manager.py icon=python lines highlight={4-11,12-14}
from salesforce_cdp_connector import SalesforceCDPConnection
...
```python error_handling.py icon=python lines highlight={4-11,12-15}
from salesforce_cdp_connector import SalesforceCDPConnection
...
```python sandbox_config.py icon=python lines highlight={2,5}
connection = SalesforceCDPConnection(
