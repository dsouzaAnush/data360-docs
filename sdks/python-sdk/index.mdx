...
<RequestExample>
```python Client Credentials Flow icon=python lines highlight={1-7}
...
```python Token Flow icon=python lines highlight={1-7}
connection = SalesforceCDPConnection(
    login_url='https://login.salesforce.com',
    client_id='YOUR_CONSUMER_KEY',
    client_secret='YOUR_CONSUMER_SECRET',
...
```python query_example.py icon=python lines highlight={4-9,12}
# Create a cursor
