...
description: "Second-generation managed packaging (managed 2GP) for Data 360 is a way for AgentExchange partners to develop, distribute, and manage their Data 360 a"
source_url: "https://developer.salesforce.com/docs/data/data-cloud-dev/guide/data-cloud-2gp-workflow.html"
source_hash: "b2a58277c9e0cac135e522efe7ae9de962b79854474c7233c2cfccf3284e805a"
source_etag: "W/\"024df99ceaeb7212b941d9c01767927d\""
...
-   In the scratch org, create your Data 360 elements: data streams, data mappings, calculated insights, streaming or batch data transforms, and so on. To know what Data 360 features can be packaged, see [Data 360 Extensibility Readiness Matrix](https://developer.salesforce.com/docs/data/data-cloud-ref/guide/c360a-api-isv-readiness-data.htm).
...
-   _Data 360 Developer Guide_: [Packages and Data Kits](https://developer.salesforce.com/docs/platform/data-cloud-dev/guide/packages-data-kits.html)
